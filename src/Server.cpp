...
void Server::clientProcessing(int socket_client, std::string ip, std::vector<InfoServer> servers) {
    ...
    switch (request.url().length()) {
        case 1: // "/"
        {
            if (request.url() == "/" && servers[0].getLocations()[0].getMethods()[0] == "GET") {
                std::ifstream html_file;
                ...
                if (servers[0].getAutoindexFlag() == true)
        ...
        case 5: // "/post.html"
        {
            if (servers[0].getLocations()[1].getPath() == "/post") {

                std::ifstream html_file;

                std::string path_res = servers[0].getLocations()[1].getRoot() + servers[0].getLocations()[1].getIndex();
                html_file.open(path_res.c_str(), std::ios::binary | std::ios::ate);
                ...
                if (request.url() == "/post" && (servers[0].getLocations()[1].getMethods()[0] == "GET" ||
                                                 servers[0].getLocations()[1].getMethods()[1] == "POST")) {
...
//CGI???
        ...
        {
            std::ifstream html_file;
            std::string path_res = "html_data/delete.html";
            html_file.open(path_res.c_str(), std::ios::binary | std::ios::ate);
        ...
        {
            std::ifstream html_file;
            std::string path_res = "html_data/uploads.html";
            html_file.open(path_res.c_str(), std::ios::binary | std::ios::ate);
...
bool Server::serverStart(std::vector<InfoServer> servers) {
    std::ifstream html_file;
    std::string path_res = servers[0].getLocations()[0].getRoot() + servers[0].getLocations()[0].getIndex();
    html_file.open(path_res.c_str(), std::ios::binary | std::ios::ate);
    ...
    while (1) {
        ...
        clientProcessing(socket_client, ip, servers);
        close(socket_client);
    }
    return true;
}
